...
export const constantRoutes = [
...

  {
    ...
    name: 'account',
    meta: {title: '账户管理', icon: 'education'},
    children: [
      {
        path: 'teacher',
        component: () => import('@/views/account/teacher'),
        name: 'teacher',
        meta: {title: '教师管理', icon: 'user'}
      },
      {
        path: 'student',
        component: () => import('@/views/account/student'),
        name: 'student',
